...
set(MSG_I_FLAGS "-Icoin_lio:/home/udi/Desktop/Degenerate/coin_lio/msg;-Igeometry_msgs:/opt/ros/melodic/share/geometry_msgs/cmake/../msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/udi/Desktop/Degenerate/coin_lio/msg/Pose6D.msg" NAME_WE)
add_custom_target(_coin_lio_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "coin_lio" "/home/udi/Desktop/Degenerate/coin_lio/msg/Pose6D.msg" ""
)
...
_generate_msg_cpp(coin_lio
  "/home/udi/Desktop/Degenerate/coin_lio/msg/Pose6D.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/coin_lio)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/coin_lio\")")
  # install generated code
  install(
