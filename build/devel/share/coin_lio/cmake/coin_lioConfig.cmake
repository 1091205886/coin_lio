...
if("TRUE" STREQUAL "TRUE")
  set(coin_lio_SOURCE_PREFIX /home/udi/Desktop/Degenerate/coin_lio)
  set(coin_lio_DEVEL_PREFIX /home/udi/Desktop/Degenerate/coin_lio/build/devel)
...
if(NOT "/home/udi/Desktop/Degenerate/coin_lio/build/devel/include;/usr/include/eigen3;/usr/include/pcl-1.8;/usr/include;/usr/include/ni;/usr/include/openni2;/usr/include/vtk-6.3;/usr/include/freetype2;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent/include;/usr/lib/x86_64-linux-gnu/openmpi/include;/usr/include/python2.7;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/libxml2;/usr/include/jsoncpp;/usr/include/tcl " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'coin_lio' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/udi/Desktop/Degenerate/coin_lio/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/udi/Desktop/Degenerate/coin_lio/build/devel/lib;/opt/ros/melodic/lib)
...
foreach(depend ${depends})
  ...
  list(APPEND coin_lio_EXPORTED_TARGETS ${${coin_lio_dep}_EXPORTED_TARGETS})
endforeach()
